...
export const page = defineType({
    ...
    fields: [
        ...
        defineField({
            ...
            hidden: ({ document }) => {
                const role = (document as { internalRole?: string })
                    ?.internalRole;
            ...
            fields: [
                defineField({
                    ...
                    title: "Produkt",
                    type: "reference",
                    to: [{ type: DOCUMENTS.productAsset }],
                    hidden: ({ document }) =>
                        (document as { internalRole?: string })
                ...
                defineField({
                    ...
                    description:
                        "Referanse til forfatteren av denne artikkelen.",
                }),
            ],
        }),
