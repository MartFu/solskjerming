...
export const articlePage = createRoutableDocument({
  ...
  extraFields: [
    defineField({
      ...
      group: GROUP.MAIN_CONTENT,
      rows: 3,
      description: "Kort oppsummering som brukes i lister og metabeskrivelser.",
    ...
    defineField({
      ...
      type: "richText",
      group: GROUP.MAIN_CONTENT,
      description: "Artikkelens hovedinnhold i tekst, bilder og formattering.",
    }),
  ],
  preview: {
    select: {
...
export const productPage = createRoutableDocument({
  ...
  extraFields: [
    ...
    defineField({
      ...
      type: "richText",
      group: GROUP.MAIN_CONTENT,
      description: "Nettstedsspesifikt kampanjeinnhold for dette produktet.",
    }),
    defineField({
      name: "coverImage",
      title: "Hovedbilde",
