...
// Used to create site scoped slugs
interface SiteDocument extends SanityDocument {
    site?: { _ref: string };
}

export function isSiteDocument(
    doc: SanityDocument | unknown,
): doc is SiteDocument {
    return (
        doc !== null &&
        typeof doc === "object" &&
        "site" in (doc as Record<string, unknown>) &&
